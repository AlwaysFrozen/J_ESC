/*
注：以下所有模型的电角度对应定子合成矢量N极，即对应转子S极指向。


BEMF使用三相引出端接高电平为N极，低电平为S极的模型计算。则转子N极靠近、S极远离时BEMF为低，N极远离、S极靠近时为高。
注：绕组做电动机时电动势方向与电流方向一致，做发电机（BEMF检测）时感应电动势与感应电流方向相反。

00000000    下半桥导通
11111111    上半桥导通
++++++++    BEMF为高
--------    BEMF为低
BEMF_state = BEMFA + (BEMFB << 1) + (BEMFC << 2);

                330     0°      30°     60°     90°     120°    150°    180°    210°    240°    270°    300°    330°    360°
BEMFA           ++++++++--------00000000000000000000000000000000--------++++++++11111111111111111111111111111111++++++++
BEMFB           11111111111111111111111111111111++++++++--------00000000000000000000000000000000--------++++++++11111111
BEMFC           0000000000000000--------++++++++11111111111111111111111111111111++++++++--------000000000000000000000000
BEMF_state      011     010             110             100             101             001             011
BEMF_state              2               6               4               5               1               3
BEMF_state delay 30° e_ang      2               6               4               5               1               3
CCW     2->6->4->5->1->3->2
CW      2->3->1->5->4->6->2
...
________    HALL输出低电平
--------    HALL输出高电平
HALL_state = HALLA + (HALLB << 1) + (HALLC << 2);
120°HallHALL使用HALLA位于30°，HALLB位于150°，HALLC位于270°,转子N极靠近为高电平，S极靠近为低电平的模型计算。
120°Hall

                330°    0°      30°     60°     90°     120°    150°    180°    210°    240°    270°    300°    330°    360°
HALLA           ________________________________________________------------------------------------------------________
HALLB           --------------------------------________________________________________________------------------------
HALLC           ________________------------------------------------------------________________________________________
HALL_state              010             110             100             101             001             011             010
HALL_state              2               6               4               5               1               3               2
    CCW     2->6->4->5->1->3->2
    CW      2->3->1->5->4->6->2

60°HallHALL使用HALLA位于30°，HALLB位于90°，HALLC位于150°,转子N极靠近为高电平，S极靠近为低电平的模型计算。
60°Hall
                330°    0°      30°     60°     90°     120°    150°    180°    210°    240°    270°    300°    330°    360°
HALLA           ________________________________________________------------------------------------------------________
HALLB           ________________________________------------------------------------------------________________________
HALLC           ________________------------------------------------------------________________________________________
HALL_state              000             100             110             111             011             001             000
HALL_state              0               4               6               7               3               1               0
    CCW     0->4->6->7->3->1->0
    CW      0->1->3->7->6->4->0
*/
...
//     .virtual_mid_filter_rate = 0.05,
//     /* VVVF config */
//     .VVVF_method = BLDC_VVVF_None,//BLDC_VVVF_VF,
//     .VVVF_ratio = 10,
//     .PWM_freq_min = 20 * 1000,
//     .PWM_freq_max = 40 * 1000,
// };
